...
FRAME_PROTOCOLS = ['eth:ethertype:ip:udp:iec-61162-450-nmea:iec-61162-450-nmea:nmea-0183', 
...
def packet_iec_450_nmea_multisentence():
    process = subprocess.run(['tshark', '-T', 'json', '-X', 'lua_script:../maritime-dissector.lua', '-r', 'iec-61162-450-nmea-multisentence.pcap'], stdout=subprocess.PIPE)
    packet = json.loads(process.stdout, object_pairs_hook=duplicate_keys_to_array)
    return packet[0]
...
@pytest.fixture
def packets_all(packet_nmea_0183, packet_nmea_0183_wrong_checksum, packet_iec_450_nmea, packet_iec_450_nmea_multitag, packet_iec_450_nmea_multisentence, packet_iec_450_nmea_wrong_tag_checksum):
    return packet_nmea_0183, packet_nmea_0183_wrong_checksum, packet_iec_450_nmea, packet_iec_450_nmea_multitag, packet_iec_450_nmea_multisentence, packet_iec_450_nmea_wrong_tag_checksum
...
def test_iec_450_nmea_multisentence(packet_iec_450_nmea_multisentence):
    ...
    for i, sentence in enumerate(packet_iec_450_nmea_multisentence['_source']['layers']['iec-61162-450-nmea-multi']['iec-61162-450-nmea']):
