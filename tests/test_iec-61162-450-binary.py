...
FRAME_PROTOCOLS = [
    "eth:ethertype:ip:udp:iec-61162-450-binary:iec-61162-450-binary",
    "eth:ethertype:ip:udp:iec-61162-450-binary:iec-61162-450-binary:binary-file-descriptor",
]
...
def packets_iec_450_binary_type1():
    process = subprocess.run(
        [
            ...
            "-r",
            f"{script_dir}/iec-61162-450-binary-type1.pcap",
            "-2",
        ],
...
def packet_iec_450_binary_type2():
    process = subprocess.run(
        [
            ...
            f"lua_script:{script_dir}/../maritime-dissector.lua",
            "-r",
            f"{script_dir}/iec-61162-450-binary-type2.pcap",
        ],
        stdout=subprocess.PIPE,
    )
...
def test_iec_450_binary_type1(packets_iec_450_binary_type1):
    ...
    assert (
        "iec-61162-450-binary.nextpacket"
        in packet1["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        not "iec-61162-450-binary.nextpacket"
        in packet2["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        not "iec-61162-450-binary.firstpacket"
        in packet1["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        "iec-61162-450-binary.firstpacket"
        in packet2["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        not "iec-61162-450-binary.prevpacket"
        in packet1["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        "iec-61162-450-binary.prevpacket"
        in packet2["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        "binary-file-descriptor" in packet1["_source"]["layers"]["iec-61162-450-binary"]
    )
    assert (
        not "binary-file-descriptor"
        in packet2["_source"]["layers"]["iec-61162-450-binary"]
    )
...
def test_iec_450_binary_type1_bfd(packet_iec_450_binary_type1_1):
    assert (
        "binary-file-descriptor.fd_length"
    ...
    assert (
        "binary-file-descriptor.type_length"
        in packet_iec_450_binary_type1_1["_source"]["layers"]["iec-61162-450-binary"][
            "binary-file-descriptor"
        ]
    )
    assert (
        "binary-file-descriptor.data_type"
        in packet_iec_450_binary_type1_1["_source"]["layers"]["iec-61162-450-binary"][
            "binary-file-descriptor"
        ]
    )
...
def test_iec_450_binary_mtype(packets_all):
    ...
    assert (
        "1"
        == packet1["_source"]["layers"]["iec-61162-450-binary"][
            "iec-61162-450-binary.mtype"
        ]
    )
    assert (
        "1"
        == packet2["_source"]["layers"]["iec-61162-450-binary"][
            "iec-61162-450-binary.mtype"
        ]
    )
    assert (
...
def test_iec_450_binary_firstpacket(packet_iec_450_binary_type1_2):
    assert (
        "1"
        == packet_iec_450_binary_type1_2["_source"]["layers"]["iec-61162-450-binary"][
            "iec-61162-450-binary.firstpacket"
        ]
    )
