...
local instance = ProtoField.uint8("nmea-2000-127514.instance", "Instance")
local generatorInstance = ProtoField.uint8("nmea-2000-127514.generatorInstance", "Generator Instance")
...
function NMEA_2000_127514.dissector(buffer, pinfo, tree)
    ...
    if buffer:len() >= (str_offset + 1 + 1) then
        subtree:add(generatorInstance, buffer(str_offset + 1, 1))
    end
