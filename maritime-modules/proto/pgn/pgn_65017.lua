...
local lineLineAcRmsVoltage = ProtoField.uint16("nmea-2000-65017.lineLineAcRmsVoltage", "Line-Line AC RMS Voltage (V)")
local lineNeutralAcRmsVoltage = ProtoField.uint16("nmea-2000-65017.lineNeutralAcRmsVoltage", "Line-Neutral AC RMS Voltage (V)")
local acFrequency = ProtoField.float("nmea-2000-65017.acFrequency", "AC Frequency (Hz)")
local acRmsCurrent = ProtoField.uint16("nmea-2000-65017.acRmsCurrent", "AC RMS Current (A)")
