...
local lineLineAcRmsVoltage = ProtoField.uint16("nmea-2000-65004.lineLineAcRmsVoltage", "Line-Line AC RMS Voltage (V)")
local lineNeutralAcRmsVoltage = ProtoField.uint16("nmea-2000-65004.lineNeutralAcRmsVoltage", "Line-Neutral AC RMS Voltage (V)")
