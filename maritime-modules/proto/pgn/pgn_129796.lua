...
local sourceId = ProtoField.float("nmea-2000-129796.sourceId", "Source ID")
...
local destinationId = ProtoField.float("nmea-2000-129796.destinationId", "Destination ID")

NMEA_2000_129796.fields = {messageId,repeatIndicator,sourceId,aisTransceiverInformation,destinationId}
