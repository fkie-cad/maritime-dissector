...
local instance = ProtoField.uint8("nmea-2000-127512.instance", "Instance")
local generatorInstance = ProtoField.uint8("nmea-2000-127512.generatorInstance", "Generator Instance")
