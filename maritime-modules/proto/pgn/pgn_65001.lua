...
local lineLineAcRmsVoltage = ProtoField.float("nmea-2000-65001.lineLineAcRmsVoltage", "Line-Line AC RMS Voltage (V)")
local lineNeutralAcRmsVoltage = ProtoField.float("nmea-2000-65001.lineNeutralAcRmsVoltage", "Line-Neutral AC RMS Voltage (V)")
