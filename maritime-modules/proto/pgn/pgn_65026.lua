...
local realPower = ProtoField.float("nmea-2000-65026.realPower", "Real Power (W)")
local apparentPower = ProtoField.float("nmea-2000-65026.apparentPower", "Apparent Power (VA)")
