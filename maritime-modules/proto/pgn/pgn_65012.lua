...
NMEA_2000_65012.fields = {reactivePower,powerFactor,powerFactorLagging}

function NMEA_2000_65012.dissector(buffer, pinfo, tree)
    local subtree_title = "PGN 65012 (Utility Phase A AC Reactive Power)"
