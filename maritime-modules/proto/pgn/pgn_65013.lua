...
local realPower = ProtoField.float("nmea-2000-65013.realPower", "Real Power (W)")
local apparentPower = ProtoField.float("nmea-2000-65013.apparentPower", "Apparent Power (VA)")
