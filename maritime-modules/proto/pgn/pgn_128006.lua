...
local sid = ProtoField.uint8("nmea-2000-128006.sid", "SID")
local identifier = ProtoField.uint8("nmea-2000-128006.identifier", "Identifier")
...
local speedControl = ProtoField.uint8("nmea-2000-128006.speedControl", "Speed Control (%)")
local controlEvents = ProtoField.uint8("nmea-2000-128006.controlEvents", "Control Events", base.HEX)
...
NMEA_2000_128006.fields = {sid,identifier,directionControl,powerEnabled,retractControl,speedControl,controlEvents,commandTimeout,azimuthControl}
...
function NMEA_2000_128006.dissector(buffer, pinfo, tree)
    ...
    subtree:add(controlEvents, buffer(str_offset + 4, 1))
