...
local measurementDate = ProtoField.uint16("nmea-2000-130322.measurementDate", "Measurement Date (d)")
...
function NMEA_2000_130322.dissector(buffer, pinfo, tree)
    ...
    if buffer:len() >= (str_offset + 1) then
        subtree:add(state, buffer(str_offset, 1))
    end
