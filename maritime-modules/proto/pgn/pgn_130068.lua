...
local startRps = ProtoField.float("nmea-2000-130068.startRps", "Start RPS#")
local nitems = ProtoField.float("nmea-2000-130068.nitems", "nItems")
local numberOfWpsInTheRouteWpList = ProtoField.float("nmea-2000-130068.numberOfWpsInTheRouteWpList", "Number of WPs in the Route/WP-List")
local databaseId = ProtoField.float("nmea-2000-130068.databaseId", "Database ID")
local routeId = ProtoField.float("nmea-2000-130068.routeId", "Route ID")
local wpId = ProtoField.float("nmea-2000-130068.wpId", "WP ID")
